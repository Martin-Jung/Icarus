...
#' @author Jim Regetz
#' @import raster
#' @param ingrid RasterLayer to smooth
#' @param sd numeric constant or rasterlayer (Default: 0.0001)
#' @param alpha alpha level for chi-square critical value
#' @param bbox optional extent object used to subset ingrid
#' 
...
dem_multiscalesmooth <- function(ingrid, sd=0.0001, alpha=0.05, bbox) {
  library(raster)
